...
module.exports = {
    ...
    devServer: { // set up webpack dev server to update js file on save
    ...
    plugins: [
        new HTMLWebpackPlugin({ // copy html file to "app folder"
        ...
        new MiniCssExtractPlugin({ // copy css file to "app" folder
